function void = main_norovirus_no_vaccine(void)
...
%params.imm_type = 0;           % classical protection
...
params.vaccine = [0 0 0 0 0];
params.vaccine_coverage_births = 0.00;
params.vaccine_coverage_booster = 0.00;
params.vaccine_coverage_booster_age = 60:100;

params.filename = 'NoV_noVaccine';
params.infile = '';
